...
---
- Done during internship at StepFun.
- Method: Pose-Conditioned Memory Retrieval recovers relevant observations from shared multi-agent history, while Visibility-Gated Peer Sharing selectively coordinates concurrently generated views.
- Outcomes: arXiv preprint, 2026
- Links: [Paper PDF](/files/2609.22641v1.pdf) | [arXiv](https://arxiv.org/abs/2609.22641)
